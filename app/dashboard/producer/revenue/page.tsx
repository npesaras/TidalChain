...
// This page retrieves the transaction mock data from the motoko backend
...
export default function RevenuePage() {
  ...
  const paymentTransactions = getTransactionsByType(transactions, 'payment').concat(getTransactionsByType(transactions, 'harvest'))
                    ...
                    <div key={payment.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                      <div className="flex items-center space-x-4">
                        <div className="p-2 bg-white rounded-lg">
                          {payment.transactionType === 'harvest' ? (
